...
// Create an interface that extends BoxProps to include the component prop
interface StyledDotProps extends BoxProps {
  component?: React.ElementType;
}

export const StyledDot = styled(Box)<StyledDotProps>(() => ({
  width: 12,
  height: 12,
  flexShrink: 0,
  display: 'flex',
