...
export const Logo = forwardRef<HTMLDivElement, LogoProps>(
  (
    ...
    const TEXT_PRIMARY = theme.vars?.palette?.text?.primary || theme.palette.text.primary;
    ...
    const PRIMARY_DARKER = theme.vars?.palette?.primary?.dark || theme.palette.primary.dark;
